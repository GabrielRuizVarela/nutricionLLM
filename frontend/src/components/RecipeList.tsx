        ...
        return (
            <div className='w-full max-w-6xl mx-auto p-6 text-center space-y-4'>
                ...
                <p className='text-muted-foreground'>
                    You haven't saved any recipes yet. Start generating recipes
        ...
        <div className='w-full max-w-6xl mx-auto p-6 space-y-6'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
                {recipes.map((recipe) => (
                    <article
                        key={recipe.id}
                        className='border dark:border-gray-800 rounded-lg p-6 space-y-4 hover:shadow-lg transition-shadow'
                    >
                        <div>
