...
export default function RecipeGenerator() {
    ...
    const [instructionsFormat, setInstructionsFormat] = useState<
        'numbered' | 'bullets'
    >('numbered');
    ...
    return (
        <div className='w-full max-w-2xl mx-auto space-y-6'>
            ...
            {generatedRecipe && (
                <div className='border dark:border-gray-800 rounded-lg p-6 space-y-4'>
                    <div>
                        <h2 className='text-2xl font-bold'>
                            {generatedRecipe.name}
                        </h2>
                        <p className='text-sm text-muted-foreground'>
                            {generatedRecipe.prep_time_minutes} minutes •{' '}
                    ...
                    <div>
                        <div className='flex items-center justify-between mb-2'>
                            ...
                            <div className='flex gap-2'>
                                <Button
                                    ...
                                    size='sm'
                                    onClick={() =>
                                        setInstructionsFormat('numbered')
                                    }
                                >
                                    Numbered
                                </Button>
                                <Button
                                    type='button'
                                    variant={
                                        instructionsFormat === 'bullets'
                                            ? 'default'
                                            : 'outline'
                                    }
                                    size='sm'
                                    onClick={() =>
                                        setInstructionsFormat('bullets')
                                    }
                                >
                                    Bullets
                                </Button>
                        ...
                        {instructionsFormat === 'numbered' ? (
                            <ol className='text-sm text-muted-foreground list-decimal list-inside space-y-1'>
                                {formatInstructions(generatedRecipe.steps).map(
                                    (step, index) => (
