"""
Django settings for nutriai_project project.
...
SECRET_KEY = 'django-insecure-lczy7+l6a*vw@+(a=8-xcx-mdv-&l5sx+ib_=%pg96f72*(#(s'
...
ROOT_URLCONF = 'nutriai_project.urls'
...
WSGI_APPLICATION = 'nutriai_project.wsgi.application'
